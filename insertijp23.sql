...
insert into smjer (sifra, naziv) values
	(null, 'Web dizajner'),
	(null, 'PHP programer');

insert into smjer (sifra, naziv, cijena) values
	(null, 'Java programer', 4999.99),
	(null, 'Računalni operater', 3050.00),
	(null, 'Android developer', 13300.00);

insert into grupa (sifra, naziv, brojPolaznika) values
	(null, 'JP23', 13),
	(null, 'PP22', 13),
	(null, 'OOP', 25);
...
('Profesor', 'Jakov', 'pjakov@gmail.com'),
...
('Mister', 'Proper', 'mrprop@prop.pr'),
('Gandalf', 'Solomon', 'gso@gso.no'),
...
select sifra from osoba where sifra > 2;

insert into clan (grupa,polaznik)
select 1,sifra from polaznik where sifra > 10;

insert into clan (grupa, polaznik)
select 2, sifra from polaznik where sifra < 11;
